...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 17, 2019 at 02:16 PM
...
--
ALTER TABLE `bid`
  ADD CONSTRAINT `bid_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `student` (`userid`),
  ADD CONSTRAINT `bid_ibfk_2` FOREIGN KEY (`code`) REFERENCES `section` (`course`);
